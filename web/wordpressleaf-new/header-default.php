					...
					<div class="account">
						...
						<ul>
							<?php if (is_user_logged_in()) { ?>
								<li class="lock"><a href="<?php echo wp_logout_url(get_home_url()); ?>"><?php esc_html_e('登出', 'diplomat'); ?></a></li>
							<?php } else { ?>
								<li data-login="loginDialog" class="lock"><a href="#"><?php esc_html_e('登录', 'diplomat'); ?></a></li>
								<li data-account="accountDialog" class="user"><a href="#"><?php esc_html_e('创建账号', 'diplomat'); ?></a></li>
							<?php } ?>
						</ul>
