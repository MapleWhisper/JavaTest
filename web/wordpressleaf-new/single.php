...
$blog_single_show_cnsocial_share = TMM::get_option("blog_single_show_cnsocial_share");
...
if (have_posts()) {
	while (have_posts()) {
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<?php if ($blog_single_show_social_share !== '0' || $blog_single_show_cnsocial_share !== '0') { ?>
			...
			<?php if ($blog_single_show_posts_nav !== '0') { ?>
				...
				<div class="single-nav clearfix">
					...
					<?php if (!empty($prev_post_url)){ ?>
						...
						<a title="<?php _e('上一篇文章', 'diplomat'); ?>" href="<?php echo esc_url($prev_post_url); ?>" class="prev">
							<?php _e('上一篇文章', 'diplomat'); ?>
					...
					<?php if (!empty($next_post_url)){ ?>
						...
						<a title="<?php _e('下一篇文章', 'diplomat'); ?>" href="<?php echo esc_url($next_post_url); ?>" class="next">
							<?php _e('下一篇文章', 'diplomat'); ?>
					...
					if (!empty($tag_ids)) {
						...
						if (!empty($my_query)) {
							...
							<div class="related-article-area">
								...
								<h2 class="section-title"><?php _e('或许您还喜欢下面的文章', 'diplomat'); ?></h2>
