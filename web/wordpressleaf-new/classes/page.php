...
class TMM_Page {
	...
	public static function init() {
		...
		self::$post_pod_types = array(
			...
			'video' => __("视频", 'diplomat'),
			'audio' => __("音频", 'diplomat'),
			//'link' => __("Link", 'diplomat'),
			'quote' => __("引语", 'diplomat'),
			'gallery' => __("相册", 'diplomat'),
		);
	...
	public static function init_meta_boxes() {
		add_meta_box("seo_options", __("Seo选项", 'diplomat'), array(__CLASS__, 'page_seo_options'), "page", "normal", "low");
		add_meta_box("seo_options", __("Seo选项", 'diplomat'), array(__CLASS__, 'page_seo_options'), "post", "normal", "low");

		add_meta_box("post_types_data", __("文章类型数据", 'diplomat'), array(__CLASS__, 'post_type_meta_panel'), "post", "normal");
        
		add_meta_box("tmm_page_bg", __("自定义页面选项", 'diplomat'), array(__CLASS__, 'page_background_options'), "post", "side", "low");
		add_meta_box("tmm_page_bg", __("自定义页面选项", 'diplomat'), array(__CLASS__, 'page_background_options'), "page", "side", "low");
                    ...
                    <tr>
                        <th style="width:25%">
                                <label for="post_type_conrainer">
                                        <strong><?php esc_html_e('相册', 'diplomat') ?></strong>
                                        <span style=" display:block; color:#999; margin:5px 0 0 0; line-height: 18px;">
                                                <?php esc_html_e('选择可折叠网格滑块', 'diplomat'); ?>
                                        </span>
                                </label>
                        </th>
                        <td>
                            ...
                            <?php if (count($sliders)==0){
								esc_html_e('请首先创建可折叠网格滑块','diplomat');
                            }else{
                            ?>
                    ...
                    <tr>
                        <th style="width:25%">
                                <label for="post_type_conrainer">
                                        <strong><?php esc_html_e('相册', 'diplomat') ?></strong>
                                        <span style=" display:block; color:#999; margin:5px 0 0 0; line-height: 18px;">
                                                <?php esc_html_e('为文章创建您的相册', 'diplomat'); ?>
                                        </span>
                                </label>
                        </th>
                        <td>
