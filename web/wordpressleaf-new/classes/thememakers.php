...
class TMM {
    ...
    public static function masonry_get_next_posts($data){
        ...
        ?>        
			...
			<a class='load-more button secondary middle' data-page-load="<?php echo esc_attr(++$page_load); ?>" data-posts-per-load="<?php echo esc_attr($posts_per_load) ?>" data-posts="<?php echo esc_attr($next_posts) ?>" href='#load-more'><?php esc_html_e('加载更多内容', 'diplomat') ?></a>
