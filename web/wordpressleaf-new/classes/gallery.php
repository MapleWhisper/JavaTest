...
class TMM_Gallery {
	...
	public static function init_meta_boxes() {
		add_meta_box("gallery_meta", __("相册图像", 'diplomat'), array(__CLASS__, 'gallery_meta'), self::$slug, "normal", "low");
		add_meta_box("tmm_page_bg", __("自定义页面选项", 'diplomat'), array('TMM_Page', 'page_background_options'), self::$slug, "side", "low");
		add_meta_box("seo_options", __("SEO选项", 'diplomat'), array('TMM_Page', 'page_seo_options'), self::$slug, "normal", "low");
	}
	...
	public static function show_edit_columns($columns) {
		$columns = array(
			...
			"image" => __("封面", 'diplomat'),
			"image_count" => __("图像计数", 'diplomat'),
			"date" => __("日期", 'diplomat')
		);
