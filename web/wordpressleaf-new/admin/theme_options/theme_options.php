...
include_once TMM_THEME_PATH . '/admin/theme_options/sections/tab_theme_author/tab_theme_author.php';
	...
	<section class="admin-container clearfix">
		...
		<section class="set-holder clearfix">
			...
			<ul class="support-links">
				<li><a class="support-docs" href="<?php echo esc_url(TMM_THEME_LINK); ?>" target="_blank"><?php esc_html_e('查看主题文档', 'diplomat'); ?></a></li>
				<li><a class="support-forum" href="<?php echo esc_url(TMM_THEME_FORUM_LINK); ?>" target="_blank"><?php esc_html_e('访问论坛', 'diplomat'); ?></a></li>
			</ul><!--/ .support-links-->

			<div class="button-options">
				<a href="#" class="admin-button button-yellow button_reset_options"><?php esc_html_e('重置全部选项', 'diplomat'); ?></a>
				<a href="#" class="admin-button button-yellow button_save_options"><?php esc_html_e('保存全部选项', 'diplomat'); ?></a>
			</div><!--/ .button-options-->
		...
		<div class="framework-container clearfix">
						...
						<?php if (!empty($section['child_sections'])){ ?>
							...
							<li>
								...
								<?php endif; ?>
									...
									<ul>
										<?php if ($section['show_general_page']): ?>
											<li><a href="#<?php echo $section_key; ?>"><?php esc_html_e('常规', 'diplomat'); ?></a></li>
										<?php endif; ?>
			...
			<section id="options-framework" class="clearfix">
				...
				<div class="admin-group-button clearfix">
					<a class="admin-button button-yellow align-left button_reset_options" href="#"><?php esc_html_e('重置全部选项', 'diplomat'); ?></a>
					<a class="admin-button button-yellow align-right button_save_options" href="#"><?php esc_html_e('保存全部选项', 'diplomat'); ?></a>
				</div>
