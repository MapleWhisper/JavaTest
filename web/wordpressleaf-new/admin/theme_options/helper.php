...
class TMM_OptionsHelper {
	...
	public static function get_default_value($val){
		$default_values  = array(
			...
			'splitted_logo_text' => 'LEAF^ Of Spring',
			...
			'blog_single_show_social_share' => '0',
			'blog_single_show_cnsocial_share' => '1',
				...
				<div class="option option-color">
					...
					<div class="controls">
						...
						<?php if (@$_GET['page'] == 'tmm_theme_options'): ?>
							<a href="javascript:void(0);" class="js_picker_val_back" title="后退"><?php esc_html_e('后退', 'diplomat'); ?></a>&nbsp;
							<a href="javascript:void(0);" class="js_picker_val_ahead" title="前进"><?php esc_html_e('前进', 'diplomat'); ?></a>&nbsp;
							<a href="javascript:void(0);" class="js_picker_val_reset" title="重置"><?php esc_html_e('重置', 'diplomat'); ?></a>
						<?php endif; ?>
					</div>
			...
			case 'upload':
				...
				<div class="option option-upload">
					...
					<div class="controls">
						...
						<a class="admin-button button_upload" href="#"><?php esc_html_e('浏览', 'diplomat'); ?></a>
					</div>
	...
	public static function get_theme_buttons() {
		return array(
			'default' => __('默认白色', 'diplomat'),
			'default-blue' => __('默认蓝色', 'diplomat')
		);
	}
	...
	public static function get_contacts_placeholder_icons() {
		return array(
			'' => "",
			'message-form-name' => __('名字', 'diplomat'),
			'message-form-email' => __('电子邮箱', 'diplomat'),
			'message-form-url' => __('网址', 'diplomat'),
			'message-form-message' => __('消息', 'diplomat')
		);
	}
