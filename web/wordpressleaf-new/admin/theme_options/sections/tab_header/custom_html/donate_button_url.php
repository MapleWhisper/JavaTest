...
<h4 class="option-title"><?php _e('捐赠按钮网址', 'diplomat'); ?></h4>
...
<div class="option option-radio">
	...
	<div class="controls">
		...
		<label for="donate_link"><span></span><?php _e('自定义链接', 'diplomat'); ?></label>&nbsp; &nbsp;
		...
		<label for="donate_page"><span></span><?php _e('选择捐赠页面', 'diplomat'); ?></label>
	</div><!--/ .controls-->
...
<ul class="show-hide-items">
	...
	<li class="donate_link" <?php echo ($donate_button_url_type === 'link' ? "" : 'style="display:none;"'); ?>>
		...
		TMM_OptionsHelper::draw_theme_option(array(
			...
			'type' => 'text',
			'default_value' => '',
			'description' => __('输入捐赠页面网址', 'diplomat'),
			'id' => 'donate_link',
	...
	<li class="donate_page" <?php echo($donate_button_url_type === 'page' ? "" : 'style="display:none;"') ?>>
		...
		TMM_OptionsHelper::draw_theme_option(array(
			...
			'default_value' => 0,
			'values' => $pages_list,
			'description' => __('选择捐赠页面', 'diplomat'),
			'id' => 'donate_page',
