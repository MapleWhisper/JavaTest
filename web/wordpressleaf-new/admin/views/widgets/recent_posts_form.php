...
<p>
    <label for="<?php echo esc_attr($widget->get_field_id('category')); ?>"><?php esc_html_e('显示分类文章', 'diplomat') ?>:</label>
	<?php
...
<p>
	<label for="<?php echo esc_attr($widget->get_field_id('number_category_posts')); ?>"><?php esc_html_e('要显示的分类文章数量', 'diplomat') ?>:</label>
...
<p>
    <label for="<?php echo esc_attr($widget->get_field_id('number_popular_posts')); ?>"><?php esc_html_e('要显示的热门文章数量', 'diplomat') ?>:</label>
...
<p>
    <label for="<?php echo esc_attr($widget->get_field_id('number_latest_posts')); ?>"><?php esc_html_e('要显示的最新文章数量', 'diplomat') ?>:</label>
...
<p>
    <label for="<?php echo esc_attr($widget->get_field_id('number_comments_posts')); ?>"><?php esc_html_e('要显示的评论文章数量', 'diplomat') ?>:</label>
...
<p>
    ...
    <label for="<?php echo esc_attr($widget->get_field_id('show_thumbnail')); ?>"><?php esc_html_e('显示缩略图', 'diplomat') ?></label>
</p>
...
<p>
    ...
    <label for="<?php echo esc_attr($widget->get_field_id('show_exerpt')); ?>"><?php esc_html_e('显示摘要', 'diplomat') ?></label>
</p>

<p>
    <label for="<?php echo esc_attr($widget->get_field_id('title_excerpt')); ?>"><?php esc_html_e('缩短文章标题', 'diplomat') ?>:</label>
...
<p>
    <label for="<?php echo esc_attr($widget->get_field_id('exerpt_symbols_count')); ?>"><?php esc_html_e('缩短文章摘要', 'diplomat') ?>:</label>
