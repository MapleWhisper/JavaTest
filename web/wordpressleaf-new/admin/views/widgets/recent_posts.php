...
<div class="widget widget_recent_posts">
    ...
    <?php 
    $def_array = array(
        'popular' => __('热门', 'diplomat'),
        'latest' => __('最新', 'diplomat'),
        'comments' => __('评论', 'diplomat')
                        );
                            ...
                            <h4 class="post-title">
                                <a href="<?php echo esc_url(get_permalink($post->ID)); ?>">
		                            ...
		                            if ((int) $instance['title_excerpt'] > 0) {
			                            echo esc_html(mb_substr(strip_tags($post->post_title), 0, (int)$instance['title_excerpt']) . " ...");
		                            } else {
                                ...
                                <p>
                                    ...
                                    <?php if (!empty($excerpt)){ ?>
                                        ...
                                        if ((int) $instance['exerpt_symbols_count'] > 0) {
                                            echo esc_html(mb_substr(strip_tags($excerpt), 0, (int)$instance['exerpt_symbols_count']) . " ...");
                                        } else {
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <?php echo esc_html(mb_substr(strip_tags($post->post_content), 0, (int)$instance['exerpt_symbols_count']) . " ..."); ?>
                                    <?php } ?>
                                </p>
                            <?php } ?>
