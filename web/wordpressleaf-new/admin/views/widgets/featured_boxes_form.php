...
<h3><?php esc_html_e('第一个框体', 'diplomat') ?></h3>

<p>
	<label for="<?php echo esc_attr($widget->get_field_id('first_box_title')); ?>"><?php esc_html_e('按钮标题', 'diplomat') ?>:</label>
...
<p>
	<label for="<?php echo esc_attr($widget->get_field_id('first_box_title_color')); ?>"><?php esc_html_e('按钮颜色', 'diplomat') ?>:</label>
	<div>
...
<p>
	<label for="<?php echo esc_attr($widget->get_field_id('first_box_color')); ?>"><?php esc_html_e('按钮背景颜色', 'diplomat') ?>:</label>
	<div>
...
<p>
	<label for="<?php echo esc_attr($widget->get_field_id('first_box_icon')); ?>"><?php esc_html_e('按钮图标', 'diplomat') ?>:</label>
	<div>
...
<p>
	<label for="<?php echo esc_attr($widget->get_field_id('first_box_link')); ?>"><?php esc_html_e('框体链接', 'diplomat') ?>:</label>
...
<h3><?php esc_html_e('第二个框体', 'diplomat') ?></h3>

<p>
	<label for="<?php echo esc_attr($widget->get_field_id('second_box_title')); ?>"><?php esc_html_e('按钮标题', 'diplomat') ?>:</label>
...
<p>
	<label for="<?php echo esc_attr($widget->get_field_id('second_box_title_color')); ?>"><?php esc_html_e('按钮标题颜色', 'diplomat') ?>:</label>
<div>
...
<p>
	<label for="<?php echo esc_attr($widget->get_field_id('second_box_color')); ?>"><?php esc_html_e('按钮背景颜色', 'diplomat') ?>:</label>
<div>
...
<p>
	<label for="<?php echo esc_attr($widget->get_field_id('second_box_icon')); ?>"><?php esc_html_e('按钮图标', 'diplomat') ?>:</label>
<div>
...
<p>
	<label for="<?php echo esc_attr($widget->get_field_id('second_box_link')); ?>"><?php esc_html_e('框体链接', 'diplomat') ?>:</label>
...
<h3><?php esc_html_e('第三个框体', 'diplomat') ?></h3>

<p>
	<label for="<?php echo esc_attr($widget->get_field_id('third_box_title')); ?>"><?php esc_html_e('按钮标题', 'diplomat') ?>:</label>
...
<p>
	<label for="<?php echo esc_attr($widget->get_field_id('third_box_title_color')); ?>"><?php esc_html_e('按钮标题颜色', 'diplomat') ?>:</label>
<div>
...
<p>
	<label for="<?php echo esc_attr($widget->get_field_id('third_box_color')); ?>"><?php esc_html_e('按钮背景颜色', 'diplomat') ?>:</label>
<div>
...
<p>
	<label for="<?php echo esc_attr($widget->get_field_id('third_box_icon')); ?>"><?php esc_html_e('按钮图标', 'diplomat') ?>:</label>
<div>
...
<p>
	<label for="<?php echo esc_attr($widget->get_field_id('third_box_link')); ?>"><?php esc_html_e('框体链接', 'diplomat') ?>:</label>
...
<h3><?php esc_html_e('第四个框体', 'diplomat') ?></h3>

<p>
	<label for="<?php echo esc_attr($widget->get_field_id('fourth_box_title')); ?>"><?php esc_html_e('按钮标题', 'diplomat') ?>:</label>
...
<p>
	<label for="<?php echo esc_attr($widget->get_field_id('fourth_box_title_color')); ?>"><?php esc_html_e('按钮标题颜色', 'diplomat') ?>:</label>
<div>
...
<p>
	<label for="<?php echo esc_attr($widget->get_field_id('fourth_box_color')); ?>"><?php esc_html_e('按钮背景颜色', 'diplomat') ?>:</label>
<div>
...
<p>
	<label for="<?php echo esc_attr($widget->get_field_id('fourth_box_icon')); ?>"><?php esc_html_e('按钮图标', 'diplomat') ?>:</label>
<div>
...
<p>
	<label for="<?php echo esc_attr($widget->get_field_id('fourth_box_link')); ?>"><?php esc_html_e('框体链接', 'diplomat') ?>:</label>
