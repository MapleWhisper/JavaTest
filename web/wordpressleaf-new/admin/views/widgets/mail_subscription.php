			...
			<?php if ($instance['zipcode']){ ?>
				...
				<div class="row collapse">
					<div class="small-6 columns">
						<input id="zipcode_<?php echo $unique_id ?>" required type="text" name="zipcode" value="" placeholder="<?php esc_attr_e('邮政编码', 'diplomat'); ?>" />
					</div>
					<div class="small-6 columns">
						<button href="#" class="button submit middle right"><?php esc_attr_e('提交', 'diplomat'); ?></button>
					</div>
				</div>
