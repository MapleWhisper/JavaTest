							...
							<th style="width:25%">
								<label for="post_type_conrainer">
									...
									<span style=" display:block; color:#999; margin:5px 0 0 0; line-height: 18px;">
										<?php esc_html_e('为这个文章设置视频', 'diplomat'); ?>
									</span>
								</label>
							</th>
							<td>                                                           
                                ...
                                &nbsp;                                
                                <a class="button button_upload_video" href="#" style="float: left; margin-left: 9px;"><?php esc_html_e('浏览', 'diplomat'); ?></a>
							</td>
						</tr>
						<tr>
							<th style="width:25%">
								<label for="post_type_conrainer">
									<span style=" display:block; color:#999; margin:5px 0 0 0; line-height: 18px;">
										<?php esc_html_e('自己网站视频的封面图像', 'diplomat'); ?>
									</span>
								</label>
							</th>
							<td>
								<div>
									...
									&nbsp;
									<a class="button button_upload" href="#" style="float: left; margin-left: 9px;"><?php esc_html_e('浏览', 'diplomat'); ?></a>
								</div>
								<br>
						...
						<tr>
							<th style="width:25%">
								<label for="post_type_conrainer">
									...
									<span style=" display:block; color:#999; margin:5px 0 0 0; line-height: 18px;">
										<?php esc_html_e('为这个文章设置音频', 'diplomat'); ?>
									</span>
								</label>
							</th>
							<td>
								<input type="text" style="width:80%; margin-right: 0; float:left;" size="30" value="<?php echo (isset($post_type_values[$post_pod_type])) ? esc_attr($post_type_values[$post_pod_type]) : '' ?>" class="" name="post_type_values[<?php echo esc_attr($post_pod_type) ?>]">
								&nbsp;<a class="button button_upload_audio image-button" href="#" style="float: left; margin-left: 9px;"><?php esc_html_e('浏览', 'diplomat'); ?></a>
							</td>
						</tr>
					</table>
					<?php
						...
						<tr>
							<th style="width:25%">
								<label for="post_type_conrainer">
									<strong><?php echo esc_html($post_type_name); ?></strong>
									<span style=" display:block; color:#999; margin:5px 0 0 0; line-height: 18px;">
										<?php esc_html_e('为此文章填入一个类似 http://site.com/ 的链接', 'diplomat'); ?>
									</span>
								</label>
							</th>
							<td>
				...
				case 'quote':
					...
					<table class="form-table">
						<tr>
							<th style="width:25%">
								<label for="post_type_conrainer">
									<strong><?php echo esc_html($post_type_name); ?></strong>
									<span style=" display:block; color:#999; margin:5px 0 0 0; line-height: 18px;">
										<?php esc_html_e('为此文章创建引用', 'diplomat'); ?>
									</span>
								</label>
							</th>
							<td>
						...
						<tr>
							<th style="width:25%">
								<label for="post_type_conrainer">
									<strong><?php esc_html_e('作者', 'diplomat'); ?></strong>
					...
					<table class="form-table">
						...
						<tr>
							<th style="width:25%">
								<label for="post_type_conrainer">
									<strong><?php echo esc_html($post_type_name); ?></strong>
									<span style=" display:block; color:#999; margin:5px 0 0 0; line-height: 18px;">
										<?php esc_html_e('创建您的相册', 'diplomat'); ?>
									</span>
								</label>
							</th>
							<td>
								<p><a href="#" class="add-images-to-page button"><?php esc_html_e('添加图像', 'diplomat'); ?></a></p>
						...
						<tr>
							<th><span style=" display:block; color:#999; margin:5px 0 0 0; line-height: 18px;">
									<?php esc_html_e('相册选项', 'diplomat'); ?>
								</span>
							</th>
							<td>
								<label for="post_type_values[<?php echo esc_attr($post_pod_type) ?>_autoplay]"><?php esc_html_e('自动播放', 'diplomat') ?></label>
								...
								<label for="post_type_values[<?php echo esc_attr($post_pod_type) ?>_speed]" style="margin-left: 40px;"><?php esc_html_e('速度', 'diplomat') ?></label>
