...
class TMM_Slider {
	...
	public static function init_meta_boxes() {
		...
		add_meta_box("tmm_slider_meta_options", __("幻灯片选项", 'diplomat'), array(__CLASS__, 'draw_slidergroup_options'), self::$slug, "normal", "low");
		add_meta_box("tmm_slides_meta", __("幻灯片", 'diplomat'), array(__CLASS__, 'draw_slidergroup_slides_meta'), self::$slug, "normal", "low");
		//***
	...
	public static function show_edit_columns($columns) {
		$columns = array(
			...
			"image" => __("分组封面", 'diplomat'),
			"count" => __("幻灯片数量", 'diplomat'),
		);
