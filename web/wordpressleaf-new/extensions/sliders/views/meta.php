...
<div id="post_slides">
    <p>
        <a href="#" class="js_add_post_slide button button-primary"><?php esc_html_e('添加文章幻灯片', 'diplomat'); ?></a>
        <a href="#" class="js_add_slide button button-primary"><?php esc_html_e('添加图片幻灯片', 'diplomat'); ?></a>
    </p>
